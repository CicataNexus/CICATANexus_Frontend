...
const apiEndpoints = {
    ...
    equipos: `https://${import.meta.env.VITE_SERVER_IP}/v1/equipment`,
    reactivos: `https://${import.meta.env.VITE_SERVER_IP}/v1/reagent`,
    materiales: `https://${import.meta.env.VITE_SERVER_IP}/v1/materials`,
};
