...
const Movements = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const requestResponse = await fetch(`https://${import.meta.env.VITE_SERVER_IP}/v1/request`);
                const equipmentResponse = await fetch(`https://${import.meta.env.VITE_SERVER_IP}/v1/equipment/basic`);
