const Footer = () => {
  return (
    <div className="flex h-fit mt-10 justify-around items-center text-center text-white bg-gradient-to-r from-blue-bg-gradient to-dim-blue-background font-montserrat text-xs">
      <div className="m-4">
